...
badd +0 txt\bigiqkids.com_wordlist_spelling_grade_1.txt
badd +0 src\com\finegamedesign\spellstone\Model.as
args notes.txt
edit notes.txt
...
silent! normal! zE
let s:l = 45 - ((21 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
45
normal! 049l
tabedit src\com\finegamedesign\spellstone\Model.as
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 170 - ((24 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
170
